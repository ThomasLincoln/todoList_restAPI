/*
 * Esse código define a classe JwtUtils, que é responsável por gerar, validar e 
 * manipular tokens JWT (JSON Web Token). Essa classe é fundamental para a 
 * implementação da autenticação baseada em JWT no Spring Security. 
 */
